...
}, "D:/Documentos/Proyectos/1.Training/lombardidev.github.io/src/components/footer/Footer.astro", void 0);
...
const $$MainHead = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<meta charset="UTF-8"><meta name="description" property="og:description"', '><meta name="viewport" content="width=device-width"><meta name="generator"', "><title>", `</title><link rel="icon" href="/public/assets/icons/logo2.png" type="image/x-icon" sizes="144x144"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Public+Sans:ital,wght@0,400;0,700;1,400&family=Rubik:wght@500;600&display=swap" rel="stylesheet"><script>
    /**
...
</h2>${renderComponent($$result, "ActionButton", $$ActionButton, { "href": "mailto:matiiaslombardi@gmail.com", "data-astro-cid-cgl7laum": true }, { "default": ($$result2) => renderTemplate`
Contacto
