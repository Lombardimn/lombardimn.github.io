...
const images = {
				...
				const frontmatter = {"title":"Markdown Mystery Tour","publishDate":"2020-03-02T00:00:00.000Z","img":"/assets/images/stock-1.jpg","img_alt":"Iridescent ripples of a bright blue and pink liquid","description":"We designed a whodunnit-style game to introduce Markdown formatting. Suspense — suspicion — syntax!\n","tags":["Design","Dev","User Testing"]};
				const file = "D:/Documentos/Proyectos/1.Training/lombardidev.github.io/src/content/project/markdown-mystery-tour.md";
				const url = undefined;
				function rawContent() {
