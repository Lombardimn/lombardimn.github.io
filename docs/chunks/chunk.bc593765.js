...
const images = {
				...
				const frontmatter = {"title":"Bloom Box","publishDate":"2019-12-01T00:00:00.000Z","img":"/assets/images/stock-2.jpg","img_alt":"A bright pink sheet of paper used to wrap flowers curves in front of rich blue background","description":"We paired with a cutting-edge music API and a team of horticulturalists\nto build AI-generated playlists that maximize houseplant health.\n","tags":["Dev","Branding","Backend"]};
				const file = "D:/Documentos/Proyectos/1.Training/lombardidev.github.io/src/content/project/bloom-box.md";
				const url = undefined;
				function rawContent() {
